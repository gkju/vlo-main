...
public static class Constants
{
    ...
    public static string CannotAddCode = "Brak uprawnień do dodania";
    public static string CannotAddUser = "Nie można dodać użytkownika";
    public static string CannotDeleteUser = "Nie można usunąć użytkownika";
